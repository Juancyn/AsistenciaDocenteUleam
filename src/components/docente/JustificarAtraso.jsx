// src/components/docente/JustificarAtraso.jsx
import React, { useState } from 'react';
import { Link } from 'react-router-dom';
import Navbar from '../layout/Navbar';
import Footer from '../layout/footer';

const JustificarAtraso = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!form.motivo) {
      setMensaje('Debe ingresar un motivo para justificar el atraso.');
      setError(true);
      return;
    }
    ...
    setMensaje('Justificación de atraso enviada correctamente.');
    setError(false);
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <textarea
                ...
                required
                placeholder="Explique detalladamente el motivo de su atraso..."
              />
            </div>
...
export default JustificarAtraso;